...
public class RegistrationActivity extends AppCompatActivity{
    ...
    private CheckBox clientCheckBox,userCheckBox;
    ...
    private void sendClientDataToFireBase(){
        FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
        DatabaseReference myRef = firebaseDatabase.getReference("Clients").child(firebaseAuth.getUid());
        userUid = firebaseAuth.getUid();
    ...
    private void setupUIViews(){
        ...
        clientCheckBox = findViewById(R.id.clientCheckboxId);
    ...
    private Boolean validate(){
        ...
        if(!clientCheckBox.isChecked() && !userCheckBox.isChecked()){
